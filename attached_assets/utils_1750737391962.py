...
def get_binary_file_downloader_html(bin_data, file_label='File', file_name='data.xlsx'):
    ...
    href = f'<a href="data:application/octet-stream;base64,{b64}" download="{file_name}" style="text-decoration:none;">Download {file_label}</a>'
    return href

def show_classification_report(report_text, model_name):
    """
    Display classification report in a formatted way
